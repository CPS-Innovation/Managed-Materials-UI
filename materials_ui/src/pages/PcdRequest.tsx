...
import { useAppRoute, useGetPcdRequest, usePcdRequestList } from '../hooks';
...
const ShowPcdId = (p: { urn: string; caseId: number; pcdId: number }) => {
...
const usePcdRequestPageAppRoute = () => {
  ...
  return { caseId: caseId!, urn: urn!, pcdId };
};
...
//   const { data: pcdDetailsData, isLoading: isPcdDetailsLoading } = useGetPcdRequest({
