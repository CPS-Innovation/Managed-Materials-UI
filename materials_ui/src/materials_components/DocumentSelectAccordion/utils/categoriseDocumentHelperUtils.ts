...
export const categoryDetails = [
  ...
  { label: 'Other material', categoryName: 'otherMaterial' },
...
export const documentTypeIdsMap: Record<TCategoryName, number[]> = {
  ...
  exhibit: [1020, 1021, 1022, 1023, 1028, 1030, 1042, 1044, 1052, 1062, 1406, 225522],
  mgForm: [
    516, 1001, 1002, 1003, 1004, 1005, 1006, 1007, 1008, 1012, 1013, 1014, 1015, 1019, 1024, 1025,
    1026, 1027, 1033, 1034, 1035, 1036, 1037, 1038, 1039, 1040, 1041, 1045, 1046, 1047, 1048, 1049,
    1050, 1060, 1061, 1063, 1066, 1203,
  ],
  otherMaterial: [-2, 1201],
  defendantPreCons: [1056, 1057],
  unusedMaterial: [1009, 1010, 1011, 1058, 1202, 100239, 226148],
};

export const initDocsOnDocCategoryNamesMap = (): { [k in TCategoryName]: TDocumentList } => ({
  statement: [],
  exhibit: [],
  mgForm: [],
  otherMaterial: [],
